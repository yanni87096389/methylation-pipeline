...
if ( ! file.exists("GSE131013_normalized_matrix.txt.gz") ) {
  download.file("https://www.ncbi.nlm.nih.gov/geo/download/?acc=GSE131013&format=file&file=GSE131013%5Fnormalized%5Fmatrix%2Etxt%2Egz",
    destfile="GSE131013_normalized_matrix.txt.gz")
}
